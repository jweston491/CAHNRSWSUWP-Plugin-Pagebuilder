		...
		load_media: function() {
			...
			if ( typeof wp !== 'undefined' && wp.media && wp.media.editor) {
				...
				jQuery( 'body' ).on( 'click', '.add-media-action', function(event) {
					...
					//get image items with existing alt and caption
					var media_section = jQuery(this).closest('.cpb-item-section.active');

					var media_alt = media_section.find('.cpb-form-field > textarea[name*="\[settings\]\[alt\]"], .cpb-form-field > input[name*="\[settings\]\[alt\]"]');

					var media_caption = media_section.find('.cpb-form-field > textarea[name*="\[settings\]\[caption\]"], .cpb-form-field > input[name*="\[settings\]\[caption\]"]');

					console.log(media_alt);
					...
					wp.media.editor.send.attachment = function(props, attachment) {
						...
						media_alt.val(attachment.alt);

						media_caption.val(attachment.caption);
